...
public final class PhoneUtils {
    ...
    public static String getAndroidId() {
        return android.provider.Settings.Secure.getString(AppUtils.getApp().getContentResolver(),
    ...
    private static TelephonyManager getTelephonyManager() {
        return (TelephonyManager) AppUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    }
