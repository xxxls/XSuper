...
public class CommonItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private final int DEFAULT_LINE_WIDTH = 20;
    ...
    private boolean isNotDrawRight(View view, RecyclerView parent, int currentPosition, int spanCount, int adapterCount) {
        ...
        if (layoutManager instanceof GridLayoutManager) {
            ...
            return ((LinearLayoutManager) layoutManager).getOrientation() == RecyclerView.VERTICAL || currentPosition == adapterCount - getFooterCount() - 1;
    ...
    public static class Builder {
        ...
        private final CommonItemDecoration divider;

        Builder() {
            divider = new CommonItemDecoration();
        }
